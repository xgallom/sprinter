...
#ifndef SPRINTER_SPRINTER_CORE_INCLUDE_CORE_HANDLER_H
#define SPRINTER_SPRINTER_CORE_INCLUDE_CORE_HANDLER_H
...
#endif //SPRINTER_SPRINTER_CORE_INCLUDE_CORE_HANDLER_H
