...
// TODO
static const uint32_t PwmFrequency = 10000;
static const uint16_t  PwmSteps = 100, ServoPwmSteps = 20000;
static const uint16_t ServoPwmFrequency = 50;
...
/* PWM output pin */
static volatile uint32_t *OutChnl[Pwms::Size] = {
